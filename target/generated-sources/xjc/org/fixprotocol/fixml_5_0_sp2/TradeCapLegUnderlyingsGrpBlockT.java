    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TradeCapLegUnderlyingsGrpBlockT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TradeCapLegUnderlyingsGrpBlockT that = ((TradeCapLegUnderlyingsGrpBlockT) object);
        {
            UnderlyingLegInstrumentBlockT lhsInstrmt;
            lhsInstrmt = this.getInstrmt();
            UnderlyingLegInstrumentBlockT rhsInstrmt;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            UnderlyingLegInstrumentBlockT theInstrmt;
