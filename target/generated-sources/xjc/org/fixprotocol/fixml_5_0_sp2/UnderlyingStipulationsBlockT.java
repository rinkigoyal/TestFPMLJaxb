    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnderlyingStipulationsBlockT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UnderlyingStipulationsBlockT that = ((UnderlyingStipulationsBlockT) object);
        {
            StipulationTypeEnumT lhsTyp;
            lhsTyp = this.getTyp();
            StipulationTypeEnumT rhsTyp;
            rhsTyp = that.getTyp();
