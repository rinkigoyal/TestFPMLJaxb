    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NestedParties4BlockT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final NestedParties4BlockT that = ((NestedParties4BlockT) object);
        {
            List<NstdPtys4SubGrpBlockT> lhsSub;
            lhsSub = (((this.sub!= null)&&(!this.sub.isEmpty()))?this.getSub():null);
            List<NstdPtys4SubGrpBlockT> rhsSub;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<NstdPtys4SubGrpBlockT> theSub;
