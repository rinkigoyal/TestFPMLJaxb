    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UndlyInstrumentPartiesBlockT)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UndlyInstrumentPartiesBlockT that = ((UndlyInstrumentPartiesBlockT) object);
        {
            List<UndlyInstrumentPtysSubGrpBlockT> lhsSub;
            lhsSub = (((this.sub!= null)&&(!this.sub.isEmpty()))?this.getSub():null);
            List<UndlyInstrumentPtysSubGrpBlockT> rhsSub;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<UndlyInstrumentPtysSubGrpBlockT> theSub;
