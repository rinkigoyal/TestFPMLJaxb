    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OrderMassCancelReportMessageT)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final OrderMassCancelReportMessageT that = ((OrderMassCancelReportMessageT) object);
        {
        ...
        }
        {
            ...
            String rhsRsp;
            rhsRsp = that.getRsp();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rsp", lhsRsp), LocatorUtils.property(thatLocator, "rsp", rhsRsp), lhsRsp, rhsRsp)) {
                return false;
            }
        }
        {
            String lhsMassCxlRejRsn;
            lhsMassCxlRejRsn = this.getMassCxlRejRsn();
            String rhsMassCxlRejRsn;
            rhsMassCxlRejRsn = that.getMassCxlRejRsn();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "massCxlRejRsn", lhsMassCxlRejRsn), LocatorUtils.property(thatLocator, "massCxlRejRsn", rhsMassCxlRejRsn), lhsMassCxlRejRsn, rhsMassCxlRejRsn)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            String theMassCxlRejRsn;
            theMassCxlRejRsn = this.getMassCxlRejRsn();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "massCxlRejRsn", theMassCxlRejRsn), currentHashCode, theMassCxlRejRsn);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            String theMassCxlRejRsn;
            theMassCxlRejRsn = this.getMassCxlRejRsn();
            strategy.appendField(locator, this, "massCxlRejRsn", buffer, theMassCxlRejRsn);
        }
        {
            BigInteger theTotAffctdOrds;
            theTotAffctdOrds = this.getTotAffctdOrds();
