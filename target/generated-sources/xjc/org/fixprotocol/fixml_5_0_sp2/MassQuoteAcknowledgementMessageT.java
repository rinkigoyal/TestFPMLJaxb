...
/**
 * MassQuoteAcknowledgement can be found in Volume 3 of the
 * 						specification
 * 
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MassQuoteAcknowledgementMessageT)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MassQuoteAcknowledgementMessageT that = ((MassQuoteAcknowledgementMessageT) object);
        {
        ...
        {
            List<QuotSetAckGrpBlockT> lhsQuotSetAck;
            lhsQuotSetAck = (((this.quotSetAck!= null)&&(!this.quotSetAck.isEmpty()))?this.getQuotSetAck():null);
            List<QuotSetAckGrpBlockT> rhsQuotSetAck;
            rhsQuotSetAck = (((that.quotSetAck!= null)&&(!that.quotSetAck.isEmpty()))?that.getQuotSetAck():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "quotSetAck", lhsQuotSetAck), LocatorUtils.property(thatLocator, "quotSetAck", rhsQuotSetAck), lhsQuotSetAck, rhsQuotSetAck)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<QuotSetAckGrpBlockT> theQuotSetAck;
            theQuotSetAck = (((this.quotSetAck!= null)&&(!this.quotSetAck.isEmpty()))?this.getQuotSetAck():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "quotSetAck", theQuotSetAck), currentHashCode, theQuotSetAck);
        }
        {
            String theReqID;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            List<QuotSetAckGrpBlockT> theQuotSetAck;
            theQuotSetAck = (((this.quotSetAck!= null)&&(!this.quotSetAck.isEmpty()))?this.getQuotSetAck():null);
            strategy.appendField(locator, this, "quotSetAck", buffer, theQuotSetAck);
        }
        {
            String theReqID;
            theReqID = this.getReqID();
